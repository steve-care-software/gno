...
func processSoftFloat64File() {
	...
	// Prepare header
	header := `// Code generated by github.com/steve-care-software/gno/gnovm/pkg/gnolang/internal/softfloat/gen. DO NOT EDIT.
...
`
	...
	newContent = strings.Replace(newContent, "import (", "import (\n\t. \"github.com/steve-care-software/gno/gnovm/pkg/gnolang/internal/softfloat\"", 1)
