...
const ImportPrefix = "github.com/steve-care-software/gno"
...
func Transpile(source, tags, filename string) (*Result, error) {
	...
	// Write file header
	out.WriteString("// Code generated by github.com/steve-care-software/gno. DO NOT EDIT.\n\n")
	if tags != "" {
			...
			case *ast.CallExpr:
				...
				case "istypednil":
					...
					c.Replace(&ast.BinaryExpr{
						...
						// and it might be better prefer if we removed the global anyway: https://github.com/steve-care-software/gno/pull/4259
					})
				case "revive":
					if len(node.Args) != 1 {
						panic(fmt.Sprintf("invalid istypednil() call with %d args", len(node.Args)))
