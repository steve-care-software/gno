...
`,
			expectedOutput: `
// Code generated by github.com/steve-care-software/gno. DO NOT EDIT.
...
import "github.com/steve-care-software/gno/gnovm/stdlibs/chain"
			...
			expectedImports: []*ast.ImportSpec{
				{
					Path: &ast.BasicLit{
						ValuePos: 21,
						Kind:     9,
						Value:    `"github.com/steve-care-software/gno/gnovm/stdlibs/chain"`,
					},
				},
			},
		},
...
import "github.com/steve-care-software/gno/examples/gno.land/r/gnoland/users/v1"
			...
			expectedImports: []*ast.ImportSpec{
				{
					Path: &ast.BasicLit{
						ValuePos: 21,
						Kind:     9,
						Value:    `"github.com/steve-care-software/gno/examples/gno.land/r/gnoland/users/v1"`,
					},
				},
			},
		},
...
import "github.com/steve-care-software/gno/examples/gno.land/p/nt/avl"
			...
			expectedImports: []*ast.ImportSpec{
				{
					Path: &ast.BasicLit{
						ValuePos: 21,
						Kind:     9,
						Value:    `"github.com/steve-care-software/gno/examples/gno.land/p/nt/avl"`,
					},
				},
			},
		},
...
import bar "github.com/steve-care-software/gno/gnovm/stdlibs/chain"
...
import "github.com/steve-care-software/gno/examples/gno.land/p/demo/unknownxyz"
`,
			...
			expectedImports: []*ast.ImportSpec{
				{
					Path: &ast.BasicLit{
						ValuePos: 21,
						Kind:     9,
						Value:    `"github.com/steve-care-software/gno/examples/gno.land/p/demo/unknownxyz"`,
					},
				},
			},
		},
...
import "github.com/steve-care-software/gno/gnovm/stdlibs/regexp"
			...
			expectedImports: []*ast.ImportSpec{
				{
					Path: &ast.BasicLit{
						ValuePos: 21,
						Kind:     9,
						Value:    `"github.com/steve-care-software/gno/gnovm/stdlibs/regexp"`,
					},
				},
			},
		},
...
import "github.com/steve-care-software/gno/gnovm/stdlibs/chain/runtime"
			...
			expectedImports: []*ast.ImportSpec{
				{
					Path: &ast.BasicLit{
						ValuePos: 22,
						Kind:     9,
						Value:    `"github.com/steve-care-software/gno/gnovm/stdlibs/chain/runtime"`,
					},
				},
			},
		},
