...
& the [tx-archive](https://github.com/steve-care-software/gno/tree/master/contribs/tx-archive) tool, the Staging
can run the latest code from the master branch on the [Gno monorepo](https://github.com/steve-care-software/gno),
...
on-chain data using the [tx-archive](https://github.com/steve-care-software/gno/tree/master/contribs/tx-archive)
...
1. *automatic* - all packages in found in the `examples/gno.land/{p,r}/` directory in the [Gno monorepo](https://github.com/steve-care-software/gno) get added to the
...
- **Timeliness of code:**
  - Packages & realms which are available in the `examples/` folder on the
    [Gno monorepo](https://github.com/steve-care-software/gno) exist on Staging in
...
- **Versioning strategy**:
  - Staging infrastructure is managed within the
    [`misc/loop`](https://github.com/steve-care-software/gno/tree/master/misc/loop) folder in the
    monorepo
...
- **Timeliness of code:**
  - Pre-deployed packages and realms are at release tag [chain/test9.0](https://github.com/steve-care-software/gno/releases/tag/chain%2Ftest9.0)
- **Intended purpose**
...
Release commit: [194903d](https://github.com/steve-care-software/gno/commit/194903db0350ace7d57910e6c34125d3aa9817da)
...
Release commit: [1ca2d97](https://github.com/steve-care-software/gno/commit/1ca2d973817b174b5b06eb9da011e1fcd2cca575)
...
Release commit: [652dc7a](https://github.com/steve-care-software/gno/commit/652dc7a3a62ee0438093d598d123a8c357bf2499)
...
Release commit: [797c7a1](https://github.com/steve-care-software/gno/commit/797c7a132d65534df373c63b837cf94b7831ac6e)
