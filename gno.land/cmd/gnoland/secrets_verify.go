...
func readAndVerifyValidatorKey(path string, io commands.IO) (*signer.FileKey, error) {
...
func readAndVerifyValidatorState(path string, io commands.IO) (*fstate.FileState, error) {
