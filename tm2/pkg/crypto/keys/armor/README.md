...
```bash
go test -v --bench github.com/steve-care-software/gno/tm2/pkg/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/steve-care-software/gno/tm2/pkg/crypto/keys/mintkey
...
PASS
ok  	github.com/steve-care-software/gno/tm2/pkg/crypto/keys/mintkey	12.093s
```
